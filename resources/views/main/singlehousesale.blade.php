...
<!-- Breadcrumb -->
<div class="breadcrumb-area section" style="background-image: url({{ asset('public/images/14.jpg') }}); height:255PX;">
                            ...
                            <div class="single-widget widget">
                                ...
                                <div class="row single-propertiy-wigets">
                                    <div class="col-lg-12 col-md-6 single-propertiy mb-30">
                                        <a href="{{ url('/singlehousesale/' . $property->id) }}"><img src="{{ asset('public/images/' . $property->Image) }}" alt="">
