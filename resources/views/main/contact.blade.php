...
<!-- Breadcrumb -->
<div class="breadcrumb-area section" style="background-image: url({{ asset('public/images/b1.png') }}); background-size: cover;">
                    ...
                    <div class="contact-form">
                        <form action="{{ route('message') }}" method="post" enctype="multipart/form-data" id="tags-form">
                            ...
                            <div class="row row-10">
                                <div class="col-md-6 col-12 mb-30"><input name="name" type="text" placeholder="Your Name" required></div>
                                <div class="col-md-6 col-12 mb-30"><input name="phone" type="text" placeholder="Phone" required></div>
                                <div class="col-12 mb-30"><textarea name="msg" placeholder="Message" required></textarea></div>
